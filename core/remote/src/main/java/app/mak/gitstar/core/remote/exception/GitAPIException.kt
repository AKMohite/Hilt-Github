package app.mak.gitstar.core.remote.exception

abstract class GitException(errorMsg: String, throwable: Throwable? = null) : Throwable(errorMsg, throwable)

open class APIException(val code: Int = 0, val errorMsg: String, throwable: Throwable? = null) : GitException(errorMsg, throwable)
...
) : GitException(errorMsg, throwable)
